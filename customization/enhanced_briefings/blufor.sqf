...
<br/>Alpha Company at Nagara;
Their orders are to maintain position and fend of any insurgents attacks following the once this morning.
<br/>Bravo Company at Zavarak and Sagram;
Their orders are to maintain position and fend of any insurgents attacks following the once this morning.
...
<br/>It in not to be expected to come across any meaningful intel;
intel discovered is to be secured after the missions main efforts is accomplished.
<br/>
...
<br/>10. fire control measures: Detailed order of priority of targets;
Sectors of fires including TRPs; Visual/Sound signals.
